...
import { collection, orderBy, getDocs, addDoc, onSnapshot, query } from 'firebase/firestore';
  ...
  return (
    <div className={styles.ChatPanel}>
      ...
      <form onSubmit={sendMessage} className={styles.form}>
        <input value={formValue} onChange={(e) => setFormValue(e.target.value)} className={styles.input} />
