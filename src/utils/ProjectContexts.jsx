...
export const ProjectContextsProvider = ({ children }) => {
  ...
  return (
    <ProjectContexts.Provider value={{ currentboard, setcurrentboard,isChatPanelVisible,isNotificationPanelVisible, setIsNotificationPanelVisible, setIsChatPanelVisible,isProjectPlanner,setisProjectPlanner, isDarkMode, setIsDarkMode }}>
      {children}
